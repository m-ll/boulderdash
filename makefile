...
#
OFILES += main.o sprite.o gba.o debug.o ext_include.o math_trigo.o background.o background_rotation.o background_text.o bg_boulder.o sprite_rotation.o sprite_bitmap.o divers.o interrupt.o save.o 
